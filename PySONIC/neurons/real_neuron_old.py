...
# @Last Modified time: 2024-03-13 18:32:18
...
class RealisticNeuron(PointNeuron):
    ...
    def alpham_SKv31(cls,Vm):
        variables = tf.gating_from_PROCEDURES(Vm=Vm, list_mod=cls.mod_files[0], mod_name='SKv31')
    ...
    def alpham_CaLVAst(cls,Vm):
        variables = tf.gating_from_PROCEDURES(Vm=Vm, list_mod=cls.mod_files[1], mod_name='CaLVAst')
        return variables['m'+'alpha']
    ...
    def alpham_NapEt2(cls,Vm):
        variables = tf.gating_from_PROCEDURES(Vm=Vm, list_mod=cls.mod_files[4], mod_name='NapEt2')
        return variables['m'+'alpha']
    ...
    def alpham_Ca(cls,Vm):
        variables = tf.gating_from_PROCEDURES(Vm=Vm, list_mod=cls.mod_files[6], mod_name='Ca')
        return variables['m'+'alpha']
    ...
    def alpham_NaTat(cls,Vm):
        variables = tf.gating_from_PROCEDURES(Vm=Vm, list_mod=cls.mod_files[7], mod_name='NaTat')
        return variables['m'+'alpha']
    ...
    def alpham_CaHVA(cls,Vm):
        variables = tf.gating_from_PROCEDURES(Vm=Vm, list_mod=cls.mod_files[8], mod_name='CaHVA')
        return variables['m'+'alpha']
    ...
    def alpham_KTst(cls,Vm):
        variables = tf.gating_from_PROCEDURES(Vm=Vm, list_mod=cls.mod_files[10], mod_name='KTst')
        return variables['m'+'alpha']
    ...
    def alpham_Im(cls,Vm):
        variables = tf.gating_from_PROCEDURES(Vm=Vm, list_mod=cls.mod_files[11], mod_name='Im')
        return variables['m'+'alpha']
    ...
    def alpham_KdShu2007(cls,Vm):
        variables = tf.gating_from_PROCEDURES(Vm=Vm, list_mod=cls.mod_files[12], mod_name='KdShu2007')
        return variables['m'+'alpha']
    ...
    def alpham_Ih(cls,Vm):
        variables = tf.gating_from_PROCEDURES(Vm=Vm, list_mod=cls.mod_files[14], mod_name='Ih')
        return variables['m'+'alpha']
    ...
    def alpham_NaTs2t(cls,Vm):
        variables = tf.gating_from_PROCEDURES(Vm=Vm, list_mod=cls.mod_files[16], mod_name='NaTs2t')
        return variables['m'+'alpha']
    ...
    def alpham_KPst(cls,Vm):
        variables = tf.gating_from_PROCEDURES(Vm=Vm, list_mod=cls.mod_files[17], mod_name='KPst')
        return variables['m'+'alpha']
